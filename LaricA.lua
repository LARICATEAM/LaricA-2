...
{text = URL.escape(titlech),url='https://telegram.me/'..database:get(bot_id..'add:ch:username'):gsub("@","")}}}   
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape('*˛ 𝖧?? 𝖻𝗋𝗈 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋𝗂𝖻𝖾 𝗍𝗈 𝗍𝗁𝖾 𝖻𝗈𝗍 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 .*').."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
os.execute('wget https://raw.githubusercontent.com/malakAlDleMLaRiCa007/LaricA/master/LaricA.lua')
os.execute('wget https://raw.githubusercontent.com/malakAlDleMLaRiCa007/LaricA/master/start.lua')
dofile('LaricA.lua')  
return false
end
if text == "راسلني" then
...
if DevLaricA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/malakAlDleMLaRiCa007/Files_LaricA/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/malakAlDleMLaRiCa007/Files_LaricA/master/Files_LaricA/"..file)
if res == 200 then
